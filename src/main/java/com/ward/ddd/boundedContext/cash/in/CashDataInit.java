...
public class CashDataInit {
    ...
    @Bean
    @Order(2)
    public ApplicationRunner cashBaseInitDataRunner() {
        return args -> {
    ...
    public void makeBaseCredits() {
        CashMember user1Member = cashFacade.findMemberByUsername("user1");
        CashMember user2Member = cashFacade.findMemberByUsername("user2");
